...
/// <summary>
/// Dati di definizione dei mondi: enum, struttura WorldModifier,
/// tabelle di bilanciamento, colori, nomi e descrizioni.
/// La logica di runtime (stato corrente, transizioni, save) resta
/// in WorldManager.
/// </summary>
...
{
    // ╔════════════════════════════════════════════════════════╗
    // ║  MODIFICATORI PER MONDO                               ║
    // ╚════════════════════════════════════════════════════════╝

    public static readonly Dictionary<WorldType, WorldModifier> Modifiers = new()
    {
        {
            WorldType.Serra,
            new WorldModifier
        ...
        },
        {
            ...
            new WorldModifier
            {
                SolarMultiplier = 0.65f,
                GravityMultiplier = 0.16f,
                OxygenLevel = 0.0f,
                TemperatureModifier = -20.0f,
                IsMeteoOn = false,
                LimitMultiplier = 2.0f,
                GrowthRateMultiplier = 0.74f,
                WaterConsumption = 0.86f,
        ...
        },
        {
            ...
            new WorldModifier
            {
                ...
                GrowthRateMultiplier = 0.53f,
                WaterConsumption = 1.28f,
        ...
        },
        {
            ...
            new WorldModifier
            {
                SolarMultiplier = 0.16f,
                GravityMultiplier = 0.13f,
                OxygenLevel = 0.0f,
                TemperatureModifier = -55.0f,
                IsMeteoOn = false,
                LimitMultiplier = 5.0f,
                GrowthRateMultiplier = 0.41f,
                WaterConsumption = 0.72f,
        ...
        },
        {
            ...
            new WorldModifier
            {
                ...
                GrowthRateMultiplier = 0.38f,
                WaterConsumption = 0.55f,
        ...
        },
        {
            ...
            new WorldModifier
            {
                SolarMultiplier = 1.35f,
                GravityMultiplier = 0.8f,
                OxygenLevel = 1.0f,
                TemperatureModifier = 5.0f,
                IsMeteoOn = true,
                LimitMultiplier = 30.0f,
                GrowthRateMultiplier = 0.93f,
                WaterConsumption = 3.4f,
                OxygenConsumption = 1.0f,
                EnergyDrain = 3.5f,
                ParasiteChance = 5.0f,
                ParasiteDamage = 3.0f,
    ...
    public static readonly Dictionary<WorldType, (Color ground1, Color ground2, Color nextGround1, Color nextGround2)> WorldColors = new()
    {
    ...
    public static Color GetWorldColor(WorldType w) => w switch
    {
    ...
    /// <summary>Sequenza di progressione dei mondi.</summary>
    ...
    public const int TOTAL_WORLDS = 10;
